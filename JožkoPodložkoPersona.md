...
- **Income:** ~45,000 € per year (Ballpark)
...
Jožko is a 50-year-old independent timber truck driver from Southern Slovenia. He is married and values family life, financial stability, and practical solutions.
...
Jožko prefers simple digital tools that save time rather than complicated systems. He is experienced with forest roads and is also a skilled mechanic, which helps him handle technical issues on the road.
...
Jožko is practical, responsible, and solution-oriented.  
...
Jožko receives a transport order from a private forest owner with only 14 m³ of logs.  
A full truck holds 32 m³.
...
- Jožko receives real-time notifications.
